...
for episode in range(0, 200):
    ...
    if episode % 100 == 0:
        torch.save(q_network.state_dict(), f"improved_dqn_100_ep{episode}.pt")
    
torch.save(q_network.state_dict(), 'improved_dqn_100.pt')
...
plt.legend()
plt.grid(True)
plt.savefig("improved_dqn_100_rewards.png")
plt.show()
